...
const adapter = projectId ? new WagmiAdapter({ networks: [akMainnet, akSepolia], projectId, ssr: true }) : null
...
const fallbackConfig = createConfig({ chains: [mainnet, sepolia], transports: { [mainnet.id]: http(), [sepolia.id]: http() }, ssr: true })
